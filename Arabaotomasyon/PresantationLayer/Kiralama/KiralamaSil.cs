...
{
    public partial class KiralamaSil : Form
    {
        ...
        {
            KiralamaPoco kirasil = new KiralamaPoco();
            kirasil = kiralamabll.silkiralama(musteriid.Text);
        ...
        private void KiralamaSil_Load(object sender, EventArgs e)
        {
            listele();
        }
    }
